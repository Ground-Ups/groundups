...
Libraries are shareable across libraries and applications. They can be imported from `@groundups/mylib`.
...
nx g @nrwl/angular:component components/button --project=groundups-ng
